...
public class ServiceHelper {
    ...
    public static String getFineMaster = "getFineMaster";
    ...
    public static String getFineMasterresp;
    ...
    public static void getFineMaster(String unitCode) {
        try {

            SoapObject request = new SoapObject(NAMESPACE, getFineMaster);
            ...
            if (null != result) {
                ...
                getFineMasterresp = result.toString();

            } else {
                getFineMasterresp = "NA";
            }
